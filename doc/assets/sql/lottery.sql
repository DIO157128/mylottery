...
*/
CREATE DATABASE IF NOT EXISTS `lottery` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin */;
USE `lottery`;
SET NAMES utf8mb4;
...
-- ----------------------------
BEGIN;
INSERT INTO `activity` VALUES (1, 100001, '测试', '啊啊啊啊', '2021-08-08 20:14:50', '2021-08-08 20:14:50', 100, 10, 0, 'xiaofuge', '2021-08-08 20:14:50', '2021-08-08 20:14:50');
COMMIT;
...
CREATE TABLE `award` (
                         ...
                         `award_content` varchar(128)  DEFAULT NULL COMMENT '奖品内容「文字描述、Key、码」',
                         `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE `strategy_detail` (
                                   ...
                                   `strategy_id` bigint(11) NOT NULL COMMENT '策略ID',
                                   `award_id` varchar(64)  DEFAULT NULL COMMENT '奖品ID',
                                   `award_name` varchar(128)  DEFAULT NULL COMMENT '奖品描述',
